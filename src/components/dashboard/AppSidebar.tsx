...
import { Users, UserPlus, FileText, Calendar, Building2, Building, Clock, BarChart3 } from 'lucide-react';
...
export function AppSidebar() {
  ...
  const menuItems = [
    ...
    { title: 'Reports', url: '/dashboard/reports', icon: BarChart3, show: isAdmin || isSalesManager },
